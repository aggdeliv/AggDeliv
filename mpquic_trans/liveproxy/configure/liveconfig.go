...
var (
	...
	//
	// go build -ldflags "-X 'github.com/gwuhaolin/liveproxy/configure.BypassInit=true'" -o liveproxy startservice.go
	BypassInit string = ""
)
...
func initDefault() {
	...
	pflag.String("config_file", "liveproxy.yml", "configure filename")
