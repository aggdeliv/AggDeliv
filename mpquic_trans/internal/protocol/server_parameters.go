...
const InitialCongestionWindow = 64
...
const MaxStreamsPerConnection = 10000
...
const MaxIncomingDynamicStreamsPerConnection = 10000
...
// revision start
const DefaultHandshakeTimeout = 100 * time.Second
